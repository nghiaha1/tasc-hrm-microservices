package com.tasc.project.apigateway.config;

/**
 * @author hoang - 01/13/2022 - 09:26:50
 */
...
public class ZuulConfiguration {
    ...
    static enum LookupHandlerCallbackFilter implements CallbackFilter {
    ...
    static enum LookupHandlerMethodInterceptor implements MethodInterceptor {
